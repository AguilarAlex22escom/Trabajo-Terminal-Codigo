...
class Tester:
    ...
    results_directory = r"C:\Users\Alexander\Documents\documentos_importantes\TrocasTuneadas\Programas\ACO"

    def __create_results_file(self):
        os.makedirs(self.results_directory, exist_ok=True)
        results_file = os.path.join(self.results_directory, "results_aco.txt")
        return results_file
    ...
    def save_results(self):
        ...
        k = int(input("Tamaño de archivo de soluciones (k): "))
